...
},{}],"clases/blocks.js":[function(require,module,exports) {
"use strict";
...
var TitleBlock = /*#__PURE__*/function (_Block) {
  ...
  function TitleBlock(value, options, newBlock) {
...
var _blocks = require("./clases/blocks");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var text = 'This app allows dynamically construct UI. Use sidebar to add elements with styles to the page.';
var model = [new _blocks.TitleBlock('Site Constructor on pure JavaScript', {
  tag: 'h2',
  styles: {
...
}), new _blocks.ColumnsBlock(['App in vanilla JavaScript without using any libraries', 'Using SOLID principles and OOP in JavaScript', 'JavaScript - easy, fun. Learning how to create UI pages'], {
  styles: {
...
exports.model = model;
},{"./assets/image.png":"assets/image.png","./clases/blocks":"clases/blocks.js"}],"clases/site.js":[function(require,module,exports) {
"use strict";
...
exports.Site = Site;
},{}],"clases/sidebar.js":[function(require,module,exports) {
"use strict";
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    key: "template",
    get: function get() {
      var arr = [(0, _utils.block)('title'), (0, _utils.block)('text')];
      var sideBlock = arr.map(function (newBlock) {
        return newBlock;
      });
      return sideBlock.join('');
    }
  }]);
...
},{"../utils":"utils.js","./blocks":"clases/blocks.js"}],"clases/app.js":[function(require,module,exports) {
"use strict";
...
exports.App = App;
},{"./site":"clases/site.js","./sidebar":"clases/sidebar.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var _app = require("./clases/app");

require("./styles/main.css");

new _app.App(_model.model).init();
},{"./model":"model.js","./clases/app":"clases/app.js","./styles/main.css":"styles/main.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
